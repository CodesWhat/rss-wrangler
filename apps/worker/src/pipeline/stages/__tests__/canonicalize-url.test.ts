...
describe("canonicalizeUrl", () => {
  ...
  it("upgrades http to https", () => {
    expect(canonicalizeUrl("http://example.com/article")).toBe("https://example.com/article");
  });
  ...
  it("removes utm_source param", () => {
    expect(canonicalizeUrl("https://example.com/page?utm_source=twitter&id=123")).toBe(
  ...
  it("removes multiple tracking params at once", () => {
    const url = "https://example.com/page?utm_source=x&utm_medium=y&utm_campaign=z&keep=1";
  ...
  it("sorts remaining query params", () => {
    expect(canonicalizeUrl("https://example.com/page?z=1&a=2&m=3")).toBe(
  ...
  it("applies all transformations together", () => {
    const raw = "http://www.Example.COM/blog/post/?utm_source=twitter&fbclid=abc&tag=news#comments";
