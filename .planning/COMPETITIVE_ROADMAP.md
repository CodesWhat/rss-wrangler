...
| Hosted SaaS offering (dogfood pilot) | ⚠️ Pending | Infra/provider decisions plus Render blueprints (`render.free.yaml`, `render.yaml`) are in repo; first live deploy + telemetry run still pending |
